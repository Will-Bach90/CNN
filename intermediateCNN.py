...
med_model = create_cnn_model(img_height, img_width)
history = train_model(med_model, train_gen, valid_gen)

# # Used when saving and later reloading the model
# med_model.save('simplified_model.h5')
# med_model = load_model('my_model.h5')

# Evaluate the model on the test data and print the testing accuracy
test_accu = med_model.evaluate(test_gen)
print('Testing accuracy:', test_accu[1] * 100, '%')

# Generate predictions for the test data
predictions = med_model.predict(test_gen, verbose=1)
